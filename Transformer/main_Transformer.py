...
from Train_Transformer import Transformer_Train
...
if __name__ == "__main__":
    ...
    model_Transformer = Transformer(input_size = params['input_size'], d_model = params['d_model'],
                             num_heads = params['num_heads'], num_encoder_layers = params['num_encoder_layers'],
                             dim_feedforward = params['dim_feedforward'], dropout = params['dropout'],
                             output_size = params['output_size']).to(device)

    loss_history = Transformer_Train(model = model_Transformer, dataloader=dataloader,
    ...
    save_path = 'saved_model/model_Transformer.pth'
